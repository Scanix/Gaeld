...
const scansThisMonth = computed(() => page.props.auth?.ocr_quota?.ocr_scans_this_month ?? 0)
const monthlyLimit = computed(() => page.props.auth?.ocr_quota?.ocr_monthly_limit ?? -1)
const usesMonthlyLimit = computed(() => monthlyLimit.value !== -1)
