...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * We back up only the database — code is versioned in Git.
                 * Storage uploads are included for receipt attachments.
                 */
                'include' => [
                    storage_path('app'),
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'contact@gaeld.ch'),
