...
// Receipt scan inbox — must be before Route::resource('expenses') to avoid {expense} catching it
Route::get('/expenses/receipt-scans', [ReceiptScanIndexController::class, 'index'])->name('expenses.receipt-scans.index');
Route::delete('/expenses/receipt-scans/{scanId}', [ReceiptScanIndexController::class, 'discard'])->name('expenses.receipt-scans.destroy');
