...
// Signed archive file download — no session required; the temporary signed URL
// generated by LegalArchiveController::download() and ::downloadPdf() is the
// sole authorisation mechanism (5-minute expiry, tamper-proof signature).
Route::get('/accounting/archives/{archive}/file', [LegalArchiveController::class, 'serveFile'])
    ->middleware('signed')
    ->name('accounting.archives.file');
